---
title: "Shipping Figma to Code"
publishedAt: "2024-04-01"
summary: "Automating the design-to-code workflow with a custom Figma plugin and CI/CD pipeline that generates production-ready React components."
images:
...
This project demonstrates your ability to leverage automation and streamline workflows, which is highly relevant for FullStack Developering portfolios focused on efficiency and innovation.